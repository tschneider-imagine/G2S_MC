...
const (
	...
	EventTypeMessageOffered           = "MESSAGE_OFFERED"
	EventTypeMessageConfirmed         = "MESSAGE_CONFIRMED"
	EventTypeMessageExpired           = "MESSAGE_EXPIRED"
	EventTypeMessageSuperseded        = "MESSAGE_SUPERSEDED"
